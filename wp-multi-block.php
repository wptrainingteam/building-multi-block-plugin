 ...
 */
function multiblock_enqueue_admin_assets()
{
    wp_enqueue_script(
        'multi-block-admin-js',
        plugin_dir_url(__FILE__) . 'build/multi-block-admin.js',
        array(),
        null,
        true
    );
}
add_action('admin_enqueue_scripts', 'multiblock_enqueue_admin_assets');
